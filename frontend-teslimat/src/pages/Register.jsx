...
export default function Register({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${host}/api/teslimat/company/register`, { 
      ...
      <div className="glass-panel" style={{ width: '100%', maxWidth: 440, padding: '2.5rem 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
            ...
            <span style={{ background: 'rgba(15,23,42,0.05)', color: 'var(--text-secondary)', fontSize: '0.75rem', padding: '0.15rem 0.5rem', borderRadius: 4, fontWeight: 600 }}>Kurye Teslimat</span>
          </div>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input 
                ...
                placeholder="Örn: Aktaş Lojistik"
